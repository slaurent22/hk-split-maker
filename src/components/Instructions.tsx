    ...
    <div id="instructions">
      ...
      <ol>
        <li>
          ...
          (Upgrade)", then use "Mask1" as the split name.
        </li>
        <li>
          ...
          <ul>
            <li>
              Mark a split as a <b>subsplit</b> by prefixing the name with a
              minus sign (-). These entries will get an autosplit and a segment
              name beginning with the minus sign, for use with the LiveSplit
              Subsplits layout component.
            </li>
            <li>
              Include your own <b>manual splits</b> by prefixing the name with a
              precent sign (%). These entries will neither get an autosplit nor
              an icon.{" "}
              <b>
                If using ordered splits, use the ManualSplit autosplit
                instead!!!
              </b>
            </li>
          </ul>
        ...
        <li>
          To <b>compare against loadless time</b>, right-click "Compare Against"
          ➡ select "Game Time"
        </li>
      </ol>
